...
abstract class LessonKitModel with _$LessonKitModel {
  ...
  factory LessonKitModel.fromEntity(LessonKit entity) => LessonKitModel(
    ...
    sourceConcepts: entity.sourceConcepts,
    likelyMisconceptions: entity.likelyMisconceptions,
    teacherMoves: entity.teacherMoves,
    checksForUnderstanding: entity.checksForUnderstanding,
