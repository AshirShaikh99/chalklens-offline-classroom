...
class _LessonKitModel extends LessonKitModel {
  const _LessonKitModel({required this.lessonTitle, required this.grade, required this.subject, required this.language, final  List<String> sourceConcepts = const <String>[], final  List<String> likelyMisconceptions = const <String>[], final  List<String> teacherMoves = const <String>[], final  List<String> checksForUnderstanding = const <String>[], final  List<String> learningObjectives = const <String>[], required this.simpleExplanation, final  List<String> blackboardNotes = const <String>[], this.localExample = '', final  List<QuizQuestionModel> oralQuiz = const <QuizQuestionModel>[], this.groupActivity = '', final  List<String> homework = const <String>[], final  List<GlossaryTermModel> glossary = const <GlossaryTermModel>[], this.easyVersion = '', this.confidence = 0.0}): _sourceConcepts = sourceConcepts,_likelyMisconceptions = likelyMisconceptions,_teacherMoves = teacherMoves,_checksForUnderstanding = checksForUnderstanding,_learningObjectives = learningObjectives,_blackboardNotes = blackboardNotes,_oralQuiz = oralQuiz,_homework = homework,_glossary = glossary,super._();
